...
\include{sections/backtracking}
\include{sections/balanced_parentheses}
\include{sections/boyer_moore_voting}
\include{sections/flood_fill}
\include{sections/kadanes_algorithm}
\include{sections/largest_area_square}
\include{sections/levenshtein_distance}
\include{sections/linked_list_cycle}
\include{sections/linked_list_remove_elements}
\include{sections/linked_list_reverse}
\include{sections/merge_sort}
\include{sections/trie}
\include{sections/valid_square}
